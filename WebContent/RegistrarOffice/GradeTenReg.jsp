...
<body>
	<div class="panel panel-default">
		...
		<div class="panel-heading">Grade 10 Students Registration</div>
...
out.print("<strong>The Following students have qualified for Grade Ten after learning Grade 9 in "+lastyear+"</strong>");
		//String filterStudents="select ";
ResultSet rs_ten=st_ten.executeQuery("select * from TBL_student where Status='active' and Grade='9' and AcademicYear='"+A_year+"'");
%>
			<span style="colr: red">${Nregistered }</span> <span style="">${registered }</span>
			<%
request.getSession().setAttribute("registered", null);
request.getSession().setAttribute("Nregistered", null);
%>
